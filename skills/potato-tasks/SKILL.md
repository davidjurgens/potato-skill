...
`references/config-keys-nested.md` lists the 350 documented **sub-keys** — the
...
| `config-keys-nested.md` | 350 sub-keys, plus what is undocumented and what is unvalidated |
