...
directory`, and `potato validate` reports the same thing without booting. Copy
shared data into the project, or move the config up to a directory that contains
both.
