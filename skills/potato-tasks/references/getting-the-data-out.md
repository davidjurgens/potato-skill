...
not N. Every format says so in its warnings and names the items, so read them —
this is the one case where the count you get and the count you expected differ
for a reason that is nobody's mistake.
