...
| `question_field`, `passage_field` | `extractive_qa` |
| `items_field` | `card_sort` |
| `profiles_field` | `conjoint` |
...
| `audio_dialogue` | Interview or podcast turns, each with a play button that seeks into the one recording | yes |
