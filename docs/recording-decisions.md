<!-- Generated by scripts/generate_references.py from skills/potato-tasks/references/recording-decisions.md. Do not edit by hand. -->

# Recording Design Decisions

`DESIGN.md`, `QUESTIONS.md`, and estimating what a task will cost. It ships with the `potato-tasks` skill:
