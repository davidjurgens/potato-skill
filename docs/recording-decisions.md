---
description: "DESIGN.md, QUESTIONS.md, and estimating what a task will cost. From potato-skill, the Claude Code skill for building Potato annotation tasks."
summary: "DESIGN.md, QUESTIONS.md, and estimating what a task will cost."
---

<!-- Generated by scripts/generate_references.py from skills/potato-skill/references/recording-decisions.md. Do not edit by hand. -->

# Recording Design Decisions

`DESIGN.md`, `QUESTIONS.md`, and estimating what a task will cost. It ships with the `potato-skill` skill:
