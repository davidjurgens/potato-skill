<!-- Generated by scripts/generate_references.py from skills/potato-tasks/references/evaluating-the-ui.md. Do not edit by hand. -->

# Evaluating and Iterating on the Interface

How to judge a rendered annotation page and what to change. It ships with the `potato-tasks` skill:
