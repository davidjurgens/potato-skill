---
description: "How to judge a rendered annotation page and what to change. From potato-skill, the Claude Code skill for building Potato annotation tasks."
summary: "How to judge a rendered annotation page and what to change."
---

<!-- Generated by scripts/generate_references.py from skills/potato-skill/references/evaluating-the-ui.md. Do not edit by hand. -->

# Evaluating and Iterating on the Interface

How to judge a rendered annotation page and what to change. It ships with the `potato-skill` skill:
