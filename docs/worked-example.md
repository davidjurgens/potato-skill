---
description: "One complete task, annotated, and what to change first. From potato-skill, the Claude Code skill for building Potato annotation tasks."
summary: "One complete task, annotated, and what to change first."
---

<!-- Generated by scripts/generate_references.py from skills/potato-skill/references/worked-example.md. Do not edit by hand. -->

# A Worked Example

One complete task, annotated, and what to change first. It ships with the `potato-skill` skill:
