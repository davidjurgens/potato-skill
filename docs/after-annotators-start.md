<!-- Generated by scripts/generate_references.py from skills/potato-tasks/references/after-annotators-start.md. Do not edit by hand. -->

# After Annotators Start

Watching a live study, what is still safe to change, and what is not. It ships with the `potato-tasks` skill:
