---
description: "Watching a live study, what is still safe to change, and what is not. From potato-skill, the Claude Code skill for building Potato annotation tasks."
summary: "Watching a live study, what is still safe to change, and what is not."
---

<!-- Generated by scripts/generate_references.py from skills/potato-skill/references/after-annotators-start.md. Do not edit by hand. -->

# After Annotators Start

Watching a live study, what is still safe to change, and what is not. It ships with the `potato-skill` skill:
