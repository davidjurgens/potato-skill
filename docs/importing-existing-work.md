---
description: "What to do when the researcher already has annotated data. From potato-skill, the Claude Code skill for building Potato annotation tasks."
summary: "What to do when the researcher already has annotated data."
---

<!-- Generated by scripts/generate_references.py from skills/potato-skill/references/importing-existing-work.md. Do not edit by hand. -->

# Importing Existing Annotations, Transcripts and Corpora

What to do when the researcher already has annotated data. It ships with the `potato-skill` skill:
