<!-- Generated by scripts/generate_references.py from skills/potato-tasks/references/importing-existing-work.md. Do not edit by hand. -->

# Importing Existing Annotations, Transcripts and Corpora

What to do when the researcher already has annotated data. It ships with the `potato-tasks` skill:
