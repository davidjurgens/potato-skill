<!-- Generated by scripts/generate_references.py from skills/potato-tasks/references/interviewing.md. Do not edit by hand. -->

# Interviewing the Researcher

The multiple-choice question bank for a task described from scratch. It ships with the `potato-tasks` skill:
