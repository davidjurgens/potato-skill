---
description: "The multiple-choice question bank for a task described from scratch. From potato-skill, the Claude Code skill for building Potato annotation tasks."
summary: "The multiple-choice question bank for a task described from scratch."
---

<!-- Generated by scripts/generate_references.py from skills/potato-skill/references/interviewing.md. Do not edit by hand. -->

# Interviewing the Researcher

The multiple-choice question bank for a task described from scratch. It ships with the `potato-skill` skill:
