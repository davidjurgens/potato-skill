---
description: "Who annotates what, and which agreement measure follows from it. From potato-skill, the Claude Code skill for building Potato annotation tasks."
summary: "Who annotates what, and which agreement measure follows from it."
---

<!-- Generated by scripts/generate_references.py from skills/potato-skill/references/assignment-and-agreement.md. Do not edit by hand. -->

# Assignment and Agreement

Who annotates what, and which agreement measure follows from it. It ships with the `potato-skill` skill:
