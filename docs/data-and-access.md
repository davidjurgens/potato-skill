---
description: "Input formats, side files, and reading results back out. From potato-skill, the Claude Code skill for building Potato annotation tasks."
summary: "Input formats, side files, and reading results back out."
---

<!-- Generated by scripts/generate_references.py from skills/potato-skill/references/data-and-access.md. Do not edit by hand. -->

# Data Files and Admin Access

Input formats, side files, and reading results back out. It ships with the `potato-skill` skill:
