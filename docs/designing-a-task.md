---
description: "The decisions behind a task, before any YAML gets written. From potato-skill, the Claude Code skill for building Potato annotation tasks."
summary: "The decisions behind a task, before any YAML gets written."
---

<!-- Generated by scripts/generate_references.py from skills/potato-skill/references/designing-a-task.md. Do not edit by hand. -->

# Designing an Annotation Task

The decisions behind a task, before any YAML gets written. It ships with the `potato-skill` skill:
