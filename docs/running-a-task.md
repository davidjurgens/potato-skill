---
description: "Booting a server, reading the startup log, and handing it over. From potato-skill, the Claude Code skill for building Potato annotation tasks."
summary: "Booting a server, reading the startup log, and handing it over."
---

<!-- Generated by scripts/generate_references.py from skills/potato-skill/references/running-a-task.md. Do not edit by hand. -->

# Running a Task

Booting a server, reading the startup log, and handing it over. It ships with the `potato-skill` skill:
