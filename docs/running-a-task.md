<!-- Generated by scripts/generate_references.py from skills/potato-tasks/references/running-a-task.md. Do not edit by hand. -->

# Running a Task

Booting a server, reading the startup log, and handing it over. It ships with the `potato-tasks` skill:
