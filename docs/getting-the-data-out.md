---
description: "The export formats, what a CSV holds, and where consent answers go. From potato-skill, the Claude Code skill for building Potato annotation tasks."
summary: "The export formats, what a CSV holds, and where consent answers go."
---

<!-- Generated by scripts/generate_references.py from skills/potato-skill/references/getting-the-data-out.md. Do not edit by hand. -->

# Getting the Annotations Out

The export formats, what a CSV holds, and where consent answers go. It ships with the `potato-skill` skill:
