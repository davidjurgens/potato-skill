<!-- Generated by scripts/generate_references.py from skills/potato-tasks/references/getting-the-data-out.md. Do not edit by hand. -->

# Getting the Annotations Out

The export formats, what a CSV holds, and where consent answers go. It ships with the `potato-tasks` skill:
