<!-- Generated by scripts/generate_references.py from skills/potato-tasks/references/interrogating-potato.md. Do not edit by hand. -->

# Interrogating Potato

Recovering an undocumented config block from the validator and the log. It ships with the `potato-tasks` skill:
