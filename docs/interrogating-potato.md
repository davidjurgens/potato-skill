---
description: "Recovering an undocumented config block from the validator and the log. From potato-skill, the Claude Code skill for building Potato annotation tasks."
summary: "Recovering an undocumented config block from the validator and the log."
---

<!-- Generated by scripts/generate_references.py from skills/potato-skill/references/interrogating-potato.md. Do not edit by hand. -->

# Interrogating Potato

Recovering an undocumented config block from the validator and the log. It ships with the `potato-skill` skill:
