<!-- Generated by scripts/generate_references.py from skills/potato-tasks/references/writing-guidelines.md. Do not edit by hand. -->

# Writing the Annotation Guidelines

Label definitions, tie-break rules and the codebook an annotator reads. It ships with the `potato-tasks` skill:
