---
description: "Label definitions, tie-break rules and the codebook an annotator reads. From potato-skill, the Claude Code skill for building Potato annotation tasks."
summary: "Label definitions, tie-break rules and the codebook an annotator reads."
---

<!-- Generated by scripts/generate_references.py from skills/potato-skill/references/writing-guidelines.md. Do not edit by hand. -->

# Writing the Annotation Guidelines

Label definitions, tie-break rules and the codebook an annotator reads. It ships with the `potato-skill` skill:
