---
description: "The whole-task modes a brief can be asking for without naming. From potato-skill, the Claude Code skill for building Potato annotation tasks."
summary: "The whole-task modes a brief can be asking for without naming."
---

<!-- Generated by scripts/generate_references.py from skills/potato-skill/references/modes-and-subsystems.md. Do not edit by hand. -->

# Modes and Subsystems

The whole-task modes a brief can be asking for without naming. It ships with the `potato-skill` skill:
