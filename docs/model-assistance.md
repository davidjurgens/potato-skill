---
description: "Pointing ai_support at your own vLLM or other OpenAI-compatible server. From potato-skill, the Claude Code skill for building Potato annotation tasks."
summary: "Pointing ai_support at your own vLLM or other OpenAI-compatible server."
---

<!-- Generated by scripts/generate_references.py from skills/potato-skill/references/model-assistance.md. Do not edit by hand. -->

# Model Assistance From a Self-Hosted Endpoint

Pointing `ai_support` at your own vLLM or other OpenAI-compatible server. It ships with the `potato-skill` skill:
