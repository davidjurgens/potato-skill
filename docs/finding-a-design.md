<!-- Generated by scripts/generate_references.py from skills/potato-tasks/references/finding-a-design.md. Do not edit by hand. -->

# Starting From a Published Design

The Potato Showcase, and what to change before reusing a design. It ships with the `potato-tasks` skill:
