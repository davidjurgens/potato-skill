---
description: "The Potato Showcase, and what to change before reusing a design. From potato-skill, the Claude Code skill for building Potato annotation tasks."
summary: "The Potato Showcase, and what to change before reusing a design."
---

<!-- Generated by scripts/generate_references.py from skills/potato-skill/references/finding-a-design.md. Do not edit by hand. -->

# Starting From a Published Design

The Potato Showcase, and what to change before reusing a design. It ships with the `potato-skill` skill:
