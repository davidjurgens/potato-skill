---
description: "Telling a config mistake from a defect, and filing the ones that are real. From potato-skill, the Claude Code skill for building Potato annotation tasks."
summary: "Telling a config mistake from a defect, and filing the ones that are real."
---

<!-- Generated by scripts/generate_references.py from skills/potato-skill/references/reporting-upstream.md. Do not edit by hand. -->

# Reporting a Bug or Asking for a Feature

Telling a config mistake from a defect, and filing the ones that are real. It ships with the `potato-skill` skill:
