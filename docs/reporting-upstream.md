<!-- Generated by scripts/generate_references.py from skills/potato-tasks/references/reporting-upstream.md. Do not edit by hand. -->

# Reporting a Bug or Asking for a Feature

Telling a config mistake from a defect, and filing the ones that are real. It ships with the `potato-tasks` skill:
