---
description: "instance_display, the display types, and what a screenshot can prove. From potato-skill, the Claude Code skill for building Potato annotation tasks."
summary: "instance_display, the display types, and what a screenshot can prove."
---

<!-- Generated by scripts/generate_references.py from skills/potato-skill/references/building-the-ui.md. Do not edit by hand. -->

# Building the Annotation Interface

`instance_display`, the display types, and what a screenshot can prove. It ships with the `potato-skill` skill:
