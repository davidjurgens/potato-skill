---
description: "Routing a medium to its display type, its scheme, and its quirks. From potato-skill, the Claude Code skill for building Potato annotation tasks."
summary: "Routing a medium to its display type, its scheme, and its quirks."
---

<!-- Generated by scripts/generate_references.py from skills/potato-skill/references/modalities.md. Do not edit by hand. -->

# Images, Video, Audio and 3D

Routing a medium to its display type, its scheme, and its quirks. It ships with the `potato-skill` skill:
