---
description: "Consent, instructions, training, surveys, and the order they run in. From potato-skill, the Claude Code skill for building Potato annotation tasks."
summary: "Consent, instructions, training, surveys, and the order they run in."
---

<!-- Generated by scripts/generate_references.py from skills/potato-skill/references/phases-and-pages.md. Do not edit by hand. -->

# Phases and Pages

Consent, instructions, training, surveys, and the order they run in. It ships with the `potato-skill` skill:
