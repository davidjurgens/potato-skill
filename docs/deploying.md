---
description: "Putting a task somewhere annotators can reach it. From potato-skill, the Claude Code skill for building Potato annotation tasks."
summary: "Putting a task somewhere annotators can reach it."
---

<!-- Generated by scripts/generate_references.py from skills/potato-skill/references/deploying.md. Do not edit by hand. -->

# Deploying a Task

Putting a task somewhere annotators can reach it. It ships with the `potato-skill` skill:
